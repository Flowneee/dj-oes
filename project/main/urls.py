...
urlpatterns = [
    ...
    url(r'^question/$', views.QuestionListView.as_view(), name='question_list'),
    url(r'^answer/$', views.AnswerListView.as_view(), name='answer_list'),

    url(r'^subject/(?P<subject_id>[0-9]+)/$', views.SubjectView, name='subject_detail'),
    url(r'^question/(?P<question_id>[0-9]+)/$', views.QuestionView, name='question_detail'),
